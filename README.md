...
A representative slice, not the whole registry (82 corpus sources as of
2026-07-22); each row carries the date its counts were read. The full
...
The registry holds **106 sources + 4 local shelves + 9 feature modules**
...
data but mints no documents of its own). All 106 sources are **wired**
...
| [docs/axes.md](docs/axes.md) | the research axes: the twenty-two scholarly desks, their personas, and which sources each tags. |
