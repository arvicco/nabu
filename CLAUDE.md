...
- **Never touch `canonical/` from application code except through `Adapter#fetch` and the ad-hoc pipeline.** Canonical data is the permanent asset. Loader and enrichers are read-only on it.
