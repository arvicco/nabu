...
class SourceRegistryTest < Minitest::Test
  ...
  def test_shipped_registry_mapping_is_valid_and_ratified
    ...
    assert_equal %w[classical epigraphy slavic germanic celtic italic romance etym biblical hebrew
                 ...
                 "and indic — the Indo-Iranian pair + romance minted P45-4 with the bfm row, " \
                 "Latin's daughters beside italic)"
