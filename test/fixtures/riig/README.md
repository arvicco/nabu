...
| `documents/IND-01-01.xml` | — | xtg-Latn | **The xtg-Lat regression exemplar** (P61-3, retrieved 2026-08-07): the file's own `textLang mainLang="xtg-Latn"` beside TWO seg readings carrying `xml:lang="xtg-Lat"` — upstream's truncated script subtag (8 live passages measured); pins `CelticLeiden::SUBTAG_REPAIRS` (Lat → Latn, evidence-keyed, never a blanket rewrite). Also mints an -fr sibling. |
