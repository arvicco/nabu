...
class RiigTest < Minitest::Test
  ...
  def test_reference_edges_capability_names_its_own_producer
    ...
    producer = Nabu::Adapters::Riig.reference_producer(catalog: nil, journal: nil)
    assert_instance_of Nabu::LibraryReferences, producer
    assert_equal "riig", producer.producer
  end
  ...
  def test_registry_row_is_disabled_manual_with_translations
    ...
    assert entry.wired, "live (owner sign-off 2026-07-18: 477 docs, flipped; sibling-noise hotfix open)"
