...
class HdicTest < Minitest::Test
  ...
  def test_manifest_carries_the_by_sa_grant_and_the_resolved_license_history
  ...
  def test_registry_row_exists_disabled_with_manual_sync_policy
    ...
    assert entry.wired, "live (D36-d owner ruling 2026-07-20: license GO; first sync owner-fired as usual)"
