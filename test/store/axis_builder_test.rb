...
module Store
  # Nabu::Store::AxisBuilder (P15-2): the date/place extractors over trimmed-real
  # HGV fixtures (test/fixtures/axis/) + catalog-side goo300k/IMP year suffixes.
  ...
  class AxisBuilderTest < Minitest::Test
    include StoreTestDB
    ...
    def test_bce_point_is_stored_verbatim
      ...
      build!
      row = axis_for("urn:nabu:ddbdp:bgu:3:994")
    ...
    def test_ce_range_keeps_both_bounds_and_precision
      ...
      build!
      row = axis_for("urn:nabu:ddbdp:bgu:2:402")
    ...
    def test_open_ended_notafter_leaves_not_before_null
      ...
      build!
      row = axis_for("urn:nabu:ddbdp:p.cair.zen:1:59108")
    ...
    def test_undated_but_placed_document_gets_a_place_only_row
      ...
      build!
      row = axis_for("urn:nabu:ddbdp:sb:1:4471")
      refute_nil row
      assert_nil row.fetch(:not_before)
    ...
    def test_multiple_alternative_origdates_envelope_min_max
      ...
      build!
      row = axis_for("urn:nabu:ddbdp:p.cair.zen:3:59354")
    ...
    def test_hgv_record_without_a_matching_document_is_skipped
      # No DDbDP document created for bgu;3;994 → no axis row, no crash.
      build!
    ...
    def test_goo300k_year_from_urn_suffix
      ...
      summary = build!
      row = axis_for("urn:nabu:goo300k:zrc_00001-1584")
    ...
    def test_imp_year_from_urn_suffix
      ...
      build!
      row = axis_for("urn:nabu:imp:wiki00266-1889")
