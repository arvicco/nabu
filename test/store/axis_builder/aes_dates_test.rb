...
module Store
  # Nabu::Store::AxisBuilder::AesDates (P28-0): document dates and findspots
  ...
  class AesDatesTest < Minitest::Test
    ...
    def build!
      Nabu::Store::AxisBuilder::AesDates.build(catalog: @db, canonical_dir: FIXTURES_ROOT)
    end
