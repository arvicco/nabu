...
module Store
  # Nabu::Store::AxisBuilder::OraccDates (P16-3): ORACC catalogue dates over
  # trimmed-real catalogue.json fixtures (test/fixtures/axis/oracc/). A fresh
  ...
  class OraccDatesTest < Minitest::Test
    ...
    def test_regnal_formula_resolves_to_the_kings_reign
      ...
      build!
      row = axis_for("urn:nabu:oracc:saao-saa01:P224395")
    ...
    def test_eponym_limu_formula_still_resolves_by_king
      ...
      build!
      row = axis_for("urn:nabu:oracc:saao-saa02:P500551")
    ...
    def test_unknown_king_zeros_fall_back_to_the_period
      ...
      build!
      row = axis_for("urn:nabu:oracc:saao-saa02:P336039")
    ...
    def test_every_census_attested_king_has_a_reign
      ...
      %w[Sargon2 Sennacherib Esarhaddon Assurbanipal Tiglath-pileser3
        ...
        assert Nabu::Store::AxisBuilder::OraccDates::REIGNS.key?(king), "#{king} missing from REIGNS"
      end
    end
    ...
    def test_absolute_bce_range_is_negated
      ...
      build!
      row = axis_for("urn:nabu:oracc:rinap-rinap1:Q003414")
    ...
    def test_ca_range_keeps_the_ca_precision
      ...
      build!
      row = axis_for("urn:nabu:oracc:riao:Q005837")
    ...
    def test_mixed_ca_range_parses
      ...
      build!
      row = axis_for("urn:nabu:oracc:riao:Q003700")
    ...
    def test_century_phrase_maps_to_bce_century_bounds
      ...
      build!
      row = axis_for("urn:nabu:oracc:riao:Q006693")
    ...
    def test_period_maps_via_the_middle_chronology_table
      ...
      build!
      row = axis_for("urn:nabu:oracc:dcclt:P212382")
    ...
    def test_unmapped_period_is_skipped_and_counted_never_guessed
      ...
      summary = build!
      row = axis_for("urn:nabu:oracc:dcclt:P230009")
    ...
    def test_compound_or_period_envelopes_its_parts
      parsed = Nabu::Store::AxisBuilder::OraccDates.period_range("Late Middle Assyrian or early Neo-Assyrian")
    ...
    def test_ascending_range_is_unparseable_not_misread_as_ce
      assert_nil Nabu::Store::AxisBuilder::OraccDates.parse_date_of_origin("681-704")
    end

    def test_year_zero_is_unparseable_never_stored
      assert_nil Nabu::Store::AxisBuilder::OraccDates.parse_date_of_origin("000")
      assert_nil Nabu::Store::AxisBuilder::OraccDates.parse_date_of_origin("704-000")
    end

    # -- the translation witness ------------------------------------------------

    def test_translation_document_carries_its_tablets_axis
      make_document("urn:nabu:oracc:saao-saa01:P224395")
      make_document("urn:nabu:oracc:saao-saa01:P224395-en", language: "eng")
      summary = build!
      row = axis_for("urn:nabu:oracc:saao-saa01:P224395-en")
      assert_equal(-721, row.fetch(:not_before))
