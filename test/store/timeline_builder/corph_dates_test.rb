...
module Store
  # Nabu::Store::TimelineBuilder::CorphDates (P25-0): TEXT.Date → timeline rows,
  ...
  class CorphDatesTest < Minitest::Test
    ...
    def build!
      Nabu::Store::TimelineBuilder::CorphDates.build(catalog: @db, canonical_dir: FIXTURES_ROOT)
    end
    ...
    def test_documents_without_a_parseable_date_are_counted_never_guessed
      ...
      outcome = Nabu::Store::TimelineBuilder::CorphDates.build(catalog: @db, canonical_dir: dir)
    ...
    def test_extract_range_prefers_the_for_text_tagged_range
      ...
      range = Nabu::Store::TimelineBuilder::CorphDates.extract_range(
    ...
    def test_extract_range_reads_the_x_style_text_date
      ...
      range = Nabu::Store::TimelineBuilder::CorphDates.extract_range("MS: 692 X 713; Text: 688 X 692")
    ...
    def test_extract_range_returns_nil_for_annalistic_prose
      ...
      assert_nil Nabu::Store::TimelineBuilder::CorphDates.extract_range(
    ...
    def test_extractor_urn_mint_matches_the_adapter
      ...
      extractor_urns = Nabu::Adapters::CorphSqlParser.new(dump).each_row("TEXT").map do |row|
        Nabu::Store::TimelineBuilder::CorphDates.document_urn(row)
      end.sort
