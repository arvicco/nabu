...
module Store
  # Nabu::Store::TimelineBuilder::TlaHfDates (P28-2): the pre-cooked
  ...
  class TlaHfDatesTest < Minitest::Test
    ...
    def build!
      Nabu::Store::TimelineBuilder::TlaHfDates.build(catalog: @db, canonical_dir: FIXTURES_ROOT)
    end
    ...
    # adapter's discover mint over the shared fixture set, or timeline rows
