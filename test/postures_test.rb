...
class PosturesTest < Minitest::Test
  ...
  def test_the_lect_migration_kept_the_p59_4_census
    ...
    assert_equal 64, lect.size,
                 ...
                 "precedent, ko-wikisource-mk identity okm; itkc ADDED P78-7 — codemap; ref " \
                 "ADDED P80-5 — pending on the de:early nabu-lects mint, the fornsvenska " \
                 "add-then-retire shape)"
    ...
    assert_equal({ "identity" => 42, "dates" => 10, "codemap" => 11, "pending" => 1 }, by_posture)
  end
end
