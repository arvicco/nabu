...
class PosturesTest < Minitest::Test
  ...
  def test_the_lect_migration_kept_the_p59_4_census
    ...
    assert_equal 64, lect.size,
                 ...
                 "ctilc ADDED P80-8 — identity, bare cat)"
    ...
    # P80-8: ctilc joined as identity (bare cat — no Catalan node in
    # nabu-lects; the variant facet is the future lect seam).
    assert_equal({ "identity" => 43, "dates" => 10, "codemap" => 11 }, by_posture)
  end
end
