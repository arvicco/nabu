...
module Nabu
  module Store
    module TimelineBuilder
      ...
      # These are MANUSCRIPT (copying) dates — the right timeline for a corpus
      ...
      # (Timeline rejects year 0) is skipped and counted invalid, never
      ...
      module CopticScriptoriumDates
        ...
        # The timeline fields, or nil when the header carries neither a date nor
