  ...
  module Store
    module TimelineBuilder
      ...
      module AesDates
        ...
        # data files (the drift-pin hook the timeline test compares against the
        # adapter's discover).
        ...
        # The timeline fields, or nil when neither the date nor the findspot
