...
module Nabu
  module Store
    module TimelineBuilder
      ...
      # WITNESS (copying/printing) dates — the right timeline for a corpus of
      ...
      module DamaskiniDates
        ...
        # The timeline fields, or nil when the header carries neither a date
