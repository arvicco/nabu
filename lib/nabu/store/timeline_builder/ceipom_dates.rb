...
module Nabu
  module Store
    module TimelineBuilder
      ...
      # the EDH decision — the timeline has no coordinate columns). GeoID
      ...
      # (10 upstream — the timeline-honest notion; the 60 coordinate-less texts
      ...
      module CeipomDates
        ...
        # the drift-pin hook the timeline test compares against the adapter's
        # discover.
        ...
        def insert_row(catalog, document_id, row, counts)
          ...
          counts[:unplaced] += 1 if timeline.nil? || timeline[:place_name].nil?
        ...
        # One text's timeline fields; nil when it carries neither date nor
