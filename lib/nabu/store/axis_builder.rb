  ...
  module Store
    ...
    module AxisBuilder
      ...
      Summary = Data.define(:hgv, :goo300k, :imp, :oracc, :torot, :coptic, :edh, :damaskini,
                            ...
                            :riig_undated, :riig_invalid, :aes_undated) do
        ...
        def total = hgv + goo300k + imp + oracc + torot + coptic + edh + damaskini + corph + riig + aes
      end
      ...
      def rebuild!(catalog:, canonical_dir:)
        ...
        Summary.new(hgv: hgv[:rows], goo300k: goo, imp: imp,
                    ...
                    riig: riig[:documents], aes: aes[:documents],
