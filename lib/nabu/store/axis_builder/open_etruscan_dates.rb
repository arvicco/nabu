...
module Nabu
  module Store
    module AxisBuilder
      ...
      # axis (P29-0) — the RiigDates shape over the two canonical flat-csv
      ...
      #   turn of era (3 rows); no year 0 exists (the DateAxis doctrine) —
      ...
      module OpenEtruscanDates
        ...
        # Walk the corpus rows, insert one axis row per dated/placed
        ...
        def insert_row(catalog, document_id, row, places, counts)
          ...
          axis = (bounds || { not_before: nil, not_after: nil, precision: nil, date_raw: nil })
