...
module Nabu
  module Store
    # One date/place axis fact for a document (P15-2, migration 008): a signed
    ...
    # it. Derived from canonical by Store::AxisBuilder; regenerated on rebuild.
    class DocumentAxis < Sequel::Model(:document_axes)
