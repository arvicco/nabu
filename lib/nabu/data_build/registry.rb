...
module Nabu
  module DataBuild
    ...
    # doctrine). The rail landed all-:planned in P50-W1; builder packets
    # flip features to :available one by one (xct/wylie-fold in P50-W3),
    # and `nabu data build` refuses the still-planned ones politely. The
