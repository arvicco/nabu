...
module Nabu
  module Query
    ...
    class Cognates
      ...
      # micro-corpora below the old floor line (hlu 7, qur 8). The mechanism
      # is scale-safe by design: the ratio binds large corpora, the absolute
      # floor binds tiny ones and only LOOSENS as they grow. P15-3 stands.
      STOP_RATIO = 0.10
      STOP_MIN_DF = 50
