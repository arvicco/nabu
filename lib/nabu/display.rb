...
module Nabu
  ...
  module Display
    ...
    class << self
      ...
      # apply grapheme spacing when policy and mode allow (P27-2), then wrap
      # in RTL isolates when both mode and policy say so. No policy, or
      # nothing changed ⇒ applied is empty and the text passes through.
