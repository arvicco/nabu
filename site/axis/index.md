...
[Open the epigraphy desk]({{ '/axis/epigraphy/' | relative_url }})
...
[Open the slavic desk]({{ '/axis/slavic/' | relative_url }})
...
[Open the etym desk]({{ '/axis/etym/' | relative_url }})
...
[Open the biblical desk]({{ '/axis/biblical/' | relative_url }})
...
[Open the hebrew desk]({{ '/axis/hebrew/' | relative_url }})
...
[Open the cuneiform desk]({{ '/axis/cuneiform/' | relative_url }})
...
[Open the indic desk]({{ '/axis/indic/' | relative_url }})
...
[Open the local desk]({{ '/axis/local/' | relative_url }})
