...
**Languages on this desk** <span title="read live from the catalog">(live doc-or-entry counts as of 4 August 2026)</span>: `ett` 7,874 · `sga` 6,564 · `gem-pro` 5,717 · `gmw-pro` 5,551 · `sla-pro` 5,431 · `eng` 3,290 · `grc` 3,201 · `lat` 2,662 · `ine-pro` 1,905 · `osc` 954 … and 24 more (`nabu axis italic` lists all).
