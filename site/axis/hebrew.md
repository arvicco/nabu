...
| `sefaria` | texts | open | wired · manual | 878 docs / 456,890 passages |
...
**Languages on this desk** <span title="read live from the catalog">(live doc-or-entry counts as of 1 August 2026)</span>: `hbo` 30,242 · `grc` 6,297 · `eng` 5,294 · `arc` 3,331 · `egy` 3,050 · `egy-Egyd` 1,424 · `ara` 962 · `cop` 456 · `heb` 408 · `lat` 317 … and 20 more (`nabu axis hebrew` lists all).
