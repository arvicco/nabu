...
**Languages on this desk** <span title="read live from the catalog">(live doc-or-entry counts as of 1 August 2026)</span>: `grc` 120,553 · `lat` 53,078 · `eng` 872 · `orv` 9 · `ota` 5 · `got` 4 · `lzh` 4 · `xcl` 4 · `cop` 3 · `egy` 3 … and 10 more (`nabu axis classical` lists all).
