...
**Languages on this desk** <span title="read live from the catalog">(live doc-or-entry counts as of 11 September 2026)</span>: `grc` 120,553 · `lat` 58,418 · `eng` 872 · `gmh` 11 · `orv` 9 · `ota` 5 · `got` 4 · `lzh` 4 · `xcl` 4 · `cop` 3 … and 12 more (`nabu axis classical` lists all).
