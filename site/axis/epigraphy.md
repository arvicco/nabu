...
**Languages on this desk** <span title="read live from the catalog">(live doc-or-entry counts as of 18 September 2026)</span>: `lat` 195,002 · `grc` 74,274 · `hit` 21,209 · `non` 20,442 · `eng` 14,964 · `ett` 6,259 · `swe` 3,393 · `egy` 3,047 · `arc` 2,970 · `cop` 2,515 … and 68 more (`nabu axis epigraphy` lists all).
