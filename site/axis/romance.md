...
**Languages on this desk** <span title="read live from the catalog">(live doc-or-entry counts as of 6 August 2026)</span>: `roa-opt` 1,682 · `lat` 1,095 · `la-vul` 233 · `fro` 222 · `gmh` 11 · `grc` 9 · `orv` 9 · `ota` 5 · `lzh` 4 · `cop` 3 … and 11 more (`nabu axis romance` lists all).
