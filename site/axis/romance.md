...
**Languages on this desk** <span title="read live from the catalog">(live doc-or-entry counts as of 18 September 2026)</span>: `lat` 6,343 · `roa-opt` 1,682 · `spa` 1,216 · `cat` 967 · `osp` 684 · `la-vul` 233 · `fro` 222 · `por` 127 · `arg` 49 · `gmh` 11 … and 22 more (`nabu axis romance` lists all).
