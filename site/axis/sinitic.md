...
**Languages on this desk** <span title="read live from the catalog">(live doc-or-entry counts as of 13 September 2026)</span>: `zho` 216,001 · `lzh` 80,220 · `ltc` 58,680 · `jpn` 32,607 · `och` 28,138 · `cmn` 7,304 · `pli` 7,288 · `sga` 6,566 · `gem-pro` 5,717 · `gmw-pro` 5,551 … and 29 more (`nabu axis sinitic` lists all).
