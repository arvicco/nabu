...
**Languages on this desk** <span title="read live from the catalog">(live doc-or-entry counts as of 26 August 2026)</span>: `egy` 51,130 · `ger` 12,985 · `cop` 12,222 · `eng` 4,861 · `grc` 3,311 · `egy-Egyd` 1,424 · `arc` 1,189 · `ara` 962 · `und` 168 · `phn` 94 … and 20 more (`nabu axis egyptian` lists all).
