...
**Languages on this desk** <span title="read live from the catalog">(live doc-or-entry counts as of 18 September 2026)</span>: `kaw` 3,632 · `obr` 1,121 · `okz-Latn` 845 · `san-Latn` 466 · `kaw-Latn` 266 · `pyx-Latn` 124 · `ocm-Latn` 74 · `osn-Latn` 27 · `khm-Latn` 23 · `omy-Latn` 20 … and 4 more (`nabu axis sea` lists all).
