...
**Languages on this desk** <span title="read live from the catalog">(live doc-or-entry counts as of 14 September 2026)</span>: `ang` 63,170 · `en` 59,433 · `non` 20,449 · `eng` 6,814 · `de` 5,668 · `swe` 3,397 · `dum` 2,226 · `lat` 532 · `gmh` 406 · `enm` 297 … and 42 more (`nabu axis germanic` lists all).
