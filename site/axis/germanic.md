...
**Languages on this desk** <span title="read live from the catalog">(live doc-or-entry counts as of 31 August 2026)</span>: `ang` 63,169 · `en` 59,433 · `non` 20,449 · `eng` 6,813 · `swe` 3,397 · `dum` 2,226 · `lat` 532 · `gmh` 406 · `enm` 297 · `gml` 235 … and 42 more (`nabu axis germanic` lists all).
