...
**Languages on this desk** <span title="read live from the catalog">(live doc-or-entry counts as of 1 August 2026)</span>: `ang` 63,169 · `non` 19,623 · `eng` 6,812 · `swe` 3,393 · `gmq-pro` 822 · `gmh` 406 · `gml` 235 · `lat` 17 · `grc` 12 · `orv` 9 … and 17 more (`nabu axis germanic` lists all).
