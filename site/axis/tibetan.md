...
**Languages on this desk** <span title="read live from the catalog">(live doc-or-entry counts as of 14 September 2026)</span>: `bod` 455,971 · `san` 9,379 · `xct` 4,564 · `otb` 410 · `en` 388 · `xzh` 5 · `eng` 1.
