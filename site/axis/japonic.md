...
**Languages on this desk** <span title="read live from the catalog">(live doc-or-entry counts as of 10 August 2026)</span>: `jpn` 287,405 · `zho` 102,998 · `lzh` 63,807 · `ojp` 11,392 · `sga` 6,564 · `gem-pro` 5,717 · `gmw-pro` 5,551 · `sla-pro` 5,431 · `ine-pro` 1,905 · `iir-pro` 799 … and 6 more (`nabu axis japonic` lists all).
