...
**Languages on this desk** <span title="read live from the catalog">(live doc-or-entry counts as of 10 August 2026)</span>: `sux` 245,387 · `akk` 129,597 · `und` 75,034 · `hit` 35,899 · `eng` 15,798 · `qpc` 8,931 · `xeb` 6,844 · `uga` 3,270 · `elx` 2,723 · `xhu` 832 … and 31 more (`nabu axis cuneiform` lists all).
