...
**Languages on this desk** <span title="read live from the catalog">(live doc-or-entry counts as of 18 August 2026)</span>: `sga` 5 · `cel` 3 · `chu` 2 · `grc` 2 · `akk` 1 · `ang` 1 · `cor` 1 · `cym` 1 · `got` 1 · `ine` 1 … and 3 more (`nabu axis local` lists all).
