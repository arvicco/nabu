...
**Languages on this desk** <span title="read live from the catalog">(live doc-or-entry counts as of 28 August 2026)</span>: `rus` 18,239 · `ine-pro` 9,117 · `gem-pro` 7,711 · `sga` 6,564 · `gmw-pro` 5,551 · `sla-pro` 5,431 · `ine` 4,981 · `ote` 2,558 · `ron` 2,270 · `itc-pro` 2,211 … and 52 more (`nabu axis etym` lists all).
