...
**Languages on this desk** <span title="read live from the catalog">(live doc-or-entry counts as of 9 August 2026)</span>: `sl` 140,164 · `chu` 4,644 · `orv` 43 · `eng` 26 · `bul` 20 · `lat` 20 · `grc` 12 · `ota` 5 · `got` 4 · `lzh` 4 … and 15 more (`nabu axis slavic` lists all).
