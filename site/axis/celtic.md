...
**Languages on this desk** <span title="read live from the catalog">(live doc-or-entry counts as of 1 August 2026)</span>: `sga` 6,672 · `gem-pro` 5,717 · `gmw-pro` 5,551 · `sla-pro` 5,431 · `ine-pro` 1,905 · `iir-pro` 799 · `mga` 770 · `wlm` 766 · `itc-pro` 745 · `xlp` 633 … and 43 more (`nabu axis celtic` lists all).
