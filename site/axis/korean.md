...
**Languages on this desk** <span title="read live from the catalog">(live doc-or-entry counts as of 11 September 2026)</span>: `lzh` 1,121,611 · `ko` 58,366 · `jpn` 17,997 · `en` 2,735 · `fra` 25 · `okm` 6.
