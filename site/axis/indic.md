...
**Languages on this desk** <span title="read live from the catalog">(live doc-or-entry counts as of 1 September 2026)</span>: `san` 209,634 · `pli` 7,288 · `eng` 4,766 · `san-Latn` 817 · `lzh` 276 · `san-Deva` 32 · `pra` 22 · `lat` 11 · `grc` 9 · `orv` 9 … and 21 more (`nabu axis indic` lists all).
