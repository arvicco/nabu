...
**Languages on this desk** <span title="read live from the catalog">(live doc-or-entry counts as of 18 August 2026)</span>: `sux` 238,796 · `akk` 106,793 · `und` 74,258 · `eng` 15,417 · `hit` 14,678 · `qpc` 8,931 · `xeb` 6,844 · `elx` 2,723 · `uga` 1,108 · `xur` 703 … and 15 more (`nabu axis iranian` lists all).
