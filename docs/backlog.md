...
## P35-3 · docs/axes.md — the public atlas page  [tier: opus] [status: done] [deps: P35-0, P35-1, P35-2]
...
## P35-6 · Recalibration + the honesty invariants  [tier: fable] [status: done 2026-07-20] [deps: P35-5]
