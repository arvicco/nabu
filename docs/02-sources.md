...
| 10 | **Papyri.info (DDbDP/HGV/APIS)** | Documentary papyri | EpiDoc TEI, full git dump (idp.data) | 4 | 4 | 4 | 5 (CC BY) | Everyday Greek/Latin — legal texts, letters. Own DDbDP parser (no CTS layer upstream). **Status: PARTIAL** — first sync 2026-07-04: 49,060 docs loaded, 21,641 quarantined (12,288 line-numbering restarts → P5 minting fix; 9,351 text-less stubs); enabled: false until fixed. |
