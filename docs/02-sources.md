...
| 5 | **TOROT (Tromsø OCS & Old Russian Treebank)** | OCS + Old East Slavic, lemmatized | PROIEL XML / CoNLL-U | 3 | 5 | 4 | 5 | Directly serves the Slavic research axis. Shares PROIEL adapter. |
...
| 10 | **Papyri.info (DDbDP/HGV/APIS)** | Documentary papyri | EpiDoc TEI, full git dump (idp.data) | 4 | 4 | 4 | 5 (CC BY) | Everyday Greek/Latin — legal texts, letters. EpiDoc adapter shared with #1. |
